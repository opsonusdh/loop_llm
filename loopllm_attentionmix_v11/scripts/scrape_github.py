...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--reject", nargs="*", help="file extensions to reject separated by comma (e.g. .lock,.min.js,.min.css)", default=".lock,.min.js,.min.css,.min.ts,.min.jsx,.min.tsx,.min.cjs,.min.mjs,.min.json,.min.html,.min.xml,.ipynb")
    return p.parse_args()
